...
echo "Creating XYZ file from CSV..."
...
# Set the bounding box manually (based on the article, or could be extracted from gmtinfo)
...
gdalinfo $GEOTIFF_FILE

# Clean up intermediate files if needed (uncomment to enable cleanup)
# rm $XYZ_FILE $CDF_FILE

echo "GeoTIFF $GEOTIFF_FILE successfully created."
